				...
				<table class="table text-center table-striped table-hover table-bordered" border="1" style="width:100%">
					<thead>
						<tr class="table-info">
							...
							<th  scope="col" class="text-uppercase" style="font-weight: bolder; font-size: 18px">Category Revuene</th>
							<th  scope="col" class="text-uppercase" style="font-weight: bolder; font-size: 18px">Category Count</th>
						</tr>
					</thead>
					<tbody>
						<c:set var="i" value="0"/>
